...
PokeDex เป็นเว็บไซต์สำหรับค้นหาและแสดงข้อมูลของ Pokémon โดยพัฒนาขึ้นเพื่อฝึกการสร้างเว็บไซต์แบบ Dynamic ด้วยภาษา JavaScript และการเชื่อมต่อกับ API ภายนอก ผู้ใช้สามารถค้นหา Pokémon ด้วยชื่อหรือหมายเลขประจำตัว (Pokédex Number) จากนั้นระบบจะดึงข้อมูลจาก **PokéAPI** มาแสดงผลแบบเรียลไทม์
